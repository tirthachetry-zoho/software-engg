...
public class DesignNotificationService {
    ...
    static class UserPreferences {
        ...
        private final Map<Channel, String> contactInfo; private final boolean doNotDisturb;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Notification notif2 = notificationService.sendNotification(1, "welcome", variables, 
            NotificationType.PROMOTION, new HashSet<>(Arrays.asList(Channel.PUSH)), 5000);
        System.out.println("Scheduled notification: " + notif2.getNotificationId());
