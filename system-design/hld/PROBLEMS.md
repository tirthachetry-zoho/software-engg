...
Scalability-oriented system designs implemented in `system-design/hld/`. Each entry links to the source file and lists the companies that commonly ask it, plus the components modeled and key architectural techniques.

## 1. URL Shortener ([URLShortener.java](URLShortener.java))
...
- **Companies**: Google, Amazon, Microsoft, Facebook, Twitter/X, ByteDance

## 2. Twitter Timeline ([DesignTwitter.java](DesignTwitter.java))
...
## 3. Chat System ([DesignChatSystem.java](DesignChatSystem.java))
...
- **Companies**: Meta, Slack, Discord, Google, Microsoft, Amazon

## 4. File Storage System ([DesignFileStorage.java](DesignFileStorage.java))
...
- **Companies**: Dropbox, Google, Amazon, Microsoft, Meta

## 5. Notification Service ([DesignNotificationService.java](DesignNotificationService.java))
...
- **Companies**: Amazon, Google, Microsoft, Meta, Uber, Netflix
