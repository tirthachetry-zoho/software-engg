...
Object-oriented designs implemented in `system-design/lld/`. Each entry links to the source file and lists the companies that commonly ask it, plus the key design decisions demonstrated in the code.

## 1. LRU Cache ([DesignLRUCache.java](DesignLRUCache.java))
...
- **Companies**: Amazon, Google, Microsoft, Facebook, Adobe, Uber

## 2. HashMap ([DesignHashMap.java](DesignHashMap.java))
...
## 3. Logger System ([DesignLogger.java](DesignLogger.java))
...
## 4. Parking Lot ([DesignParkingLot.java](DesignParkingLot.java))
